...
if is_banned(data.id_, arg.chat_id) then
   if not lang then
		...
		tdcli.sendMessage(arg.chat_id, arg.msg_id, 0, "_کاربر_ "..user_name.." *[ "..data.id_.." ]* _از گروه محروم است.\n\n> کاربر قادر به ورود به گروه نیست._", 0, "md")
end
kick_user(data.id_, arg.chat_id)
end
if is_gbanned(data.id_) then
     if not lang then
		...
		tdcli.sendMessage(arg.chat_id, arg.msg_id, 0, "_کاربر_ "..user_name.." *[ "..data.id_.." ]* _از تمام گروه های ربات محروم است.\n\n> کاربر قادر به ورود به هیچکدام از گروه های ربات نیست._", 0, "md")
   end
kick_user(data.id_, arg.chat_id)
     end
	end
...
if administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] then
    if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* * از قبل از گروه محروم بود.\n\n> کاربر قادر به ورود به گروه نیست.*", 0, "md")
      end
   end
administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] = user_name
   ...
   kick_user(data.id_, arg.chat_id)
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* *به دلیل رعایت نکردن قوانین گروه از گروه محروم شد.\n\n> کاربر از این لحظه قادر به ورود به گروه نیست.*", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
if not administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] then
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* *از گروه محروم نیست.\n\n> کاربر قادر به ورود به گروه می باشد.*", 0, "md")
      end
   end
administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] = nil
   ...
   if not lang then
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* *از محرومیت گروه خارج شد.\n\n> کاربر از این لحظه می تواند وارد گروه شود. *", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
if administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] then
    if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* *به دلیل رعایت نکردن قوانین گپ از قبل در حالت سکوت بود.*\n\n*> کاربر قادر به چت کردن نیست.*", 0, "md")
     end
   end
administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] = user_name
  ...
  if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* *به دلیل رعایت نکردن قوانین گپ در حالت سکوت قرار گرفت.*\n\n*> تمامی پیام های این شخص از این لحظه پاک خواهند شد.*", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
if not administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] then
   if not lang then
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* *در حالت سکوت نیست.*\n\n*> کاربر قادر به چت کردن است.*", 0, "md")
      end
   end
administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] = nil
    ...
    if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* *از حالت سکوت خارج شد.*\n\n*> کاربر از این لحظه قادر به چت کردن است.*", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
if is_gbanned(data.id_) then
   if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* *از قبل از تمام گروه های ربات محروم بود.\n\n> کاربر قادر به ورود به هیچکدام از گروه های ربات نیست.*", 0, "md")
      end
   end
  administration['gban_users'][tostring(data.id_)] = user_name
   ...
   kick_user(data.id_, arg.chat_id)
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* *به دلیل رعایت نکردن قوانین گروه از تمام گروه های ربات محروم شد.\n\n> کاربر از این لحظه قادر به ورود به هیچکدام از گروه های ربات نیست.*", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
if not is_gbanned(data.id_) then
   if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* *از گروه های ربات محروم نبود.\n\n> کاربر قادر به ورود به تمامی گروه های ربات را دارد.*", 0, "md")
      end
   end
  administration['gban_users'][tostring(data.id_)] = nil
    ...
    if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* *از محرومیت گروه های ربات خارج شد.\n\n> کاربر از این لحظه قادر به ورود به تمامی گروه های ربات است.*", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
kick_user(matches[2], msg.to.id)
 ...
 if matches[1] == "delall" and is_mod(msg) or matches[1] == "پاک کردن" and is_mod(msg) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
...
if not matches[2] and msg.reply_id then
  ...
  return tdcli.sendMessage(msg.to.id, "", 0, "*کاربر "..matches[2].." از قبل از تمام گروه های ربات محروم بود.\n\n> کاربر قادر به ورود به هیچکدام از گروه های ربات نیست.*", 0, "md")
        end
     end
...
kick_user(matches[2], msg.to.id)
 ...
 return tdcli.sendMessage(msg.to.id, msg.id, 0, "*کاربر "..matches[2].." به دلیل رعایت نکردن قوانین گروه از تمام گروه های ربات محروم شد.\n\n> کاربر از این لحظه قادر به ورود به هیچکدام از گروه های ربات نیست.*", 0, "md")
      end
   end
  if matches[2] and not string.match(matches[2], '^%d+$') then
    tdcli_function ({
 ...
 if matches[1] == "unbanall" and is_admin(msg) or matches[1] == "ازاد کلی" and is_admin(msg) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   return tdcli.sendMessage(msg.to.id, "", 0, "*کاربر "..matches[2].." از گروه های ربات محروم نبود.\n\n> کاربر قادر به ورود به تمامی گروه های ربات را دارد.*", 0, "md")
        end
     end
...
return tdcli.sendMessage(msg.to.id, msg.id, 0, "*کاربر "..matches[2].." از محرومیت گروه های ربات خارج شد.\n\n> کاربر از این لحظه قادر به ورود به تمامی گروه های ربات است. *", 0, "md")
      end
   end
  if matches[2] and not string.match(matches[2], '^%d+$') then
    tdcli_function ({
...
if not matches[2] and msg.reply_id then
  ...
  return tdcli.sendMessage(msg.to.id, "", 0, "*کاربر "..matches[2].." از قبل از گروه محروم بود.\n\n> کاربر قادر به ورود به گروه نیست.*", 0, "md")
        end
     end
...
kick_user(matches[2], msg.to.id)
 ...
 return tdcli.sendMessage(msg.to.id, msg.id, 0, "*کاربر "..matches[2].." به دلیل رعایت نکردن قوانین گروه از گروه محروم شد.\n\n> کاربر از این لحظه قادر به ورود به گروه نیست.*", 0, "md")
      end
   end
  if matches[2] and not string.match(matches[2], '^%d+$') then
     tdcli_function ({
...
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   return tdcli.sendMessage(msg.to.id, "", 0, "*کاربر "..matches[2].." از گروه محروم نیست.\n\n> کاربر قادر به ورود به گروه می باشد.*", 0, "md")
        end
     end
...
return tdcli.sendMessage(msg.to.id, msg.id, 0, "*کاربر "..matches[2].." از محرومیت گروه خارج شد.\n\n> کاربر از این لحظه می تواند وارد گروه شود.*", 0, "md")
      end
   end
  if matches[2] and not string.match(matches[2], '^%d+$') then
    tdcli_function ({
 ...
 if matches[1] == "silent" and is_mod(msg) or matches[1] == "سکوت" and is_mod(msg) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   return tdcli.sendMessage(msg.to.id, "", 0, "*کاربر "..matches[2].." به دلیل رعایت نکردن قوانین گپ از قبل در حالت سکوت بود.*\n\n*> کاربر قادر به چت کردن نیست.*", 0, "md")
        end
     end
data[tostring(chat)]['is_silent_users'][tostring(matches[2])] = ""
 ...
 return tdcli.sendMessage(msg.to.id, msg.id, 0, "*کاربر "..matches[2].." به دلیل رعایت نکردن قوانین گپ در حالت سکوت قرار گرفت.*\n\n*> تمامی پیام های این شخص از این لحظه پاک خواهند شد.*", 0, "md")
      end
   end
  if matches[2] and not string.match(matches[2], '^%d+$') then
    tdcli_function ({
 ...
 if matches[1] == "unsilent" and is_mod(msg) or matches[1] == "لغو سکوت" and is_mod(msg) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   if not is_silent_user(matches[2], chat) then
     ...
     return tdcli.sendMessage(msg.to.id, "", 0, "*کاربر "..matches[2].." در حالت سکوت نیست.*\n\n*> کاربر قادر به چت کردن است.*", 0, "md")
        end
     end
data[tostring(chat)]['is_silent_users'][tostring(matches[2])] = nil
 ...
 return tdcli.sendMessage(msg.to.id, msg.id, 0, "*کاربر "..matches[2].." از حالت سکوت خارج شد.*\n\n*> کاربر از این لحظه قادر به چت کردن است.*", 0, "md")
      end
   end
  if matches[2] and not string.match(matches[2], '^%d+$') then
   tdcli_function ({
      ...
      username_ = matches[2]
		...
		if matches[1]:lower() == 'clean' and is_owner(msg) or matches[1]:lower() == 'پاکسازی' and is_owner(msg) then
			if matches[2] == 'bans' or matches[2] == 'مسدودها' then
     ...
     if not lang then
       ...
       if not lang then
		...
		if matches[1]:lower() == 'clean' and is_sudo(msg) or matches[1]:lower() == 'پاکسازی' and is_sudo(msg) then
			if matches[2] == 'gbans' or matches[2] == 'مسدود کلی' then
...
if matches[1] == "gbanlist" and is_admin(msg) or matches[1] == "لیست مسدود کلی" and is_admin(msg) then
  return gbanned_list(msg)
 end
   if msg.to.type ~= 'pv' then
if matches[1] == "silentlist" and is_mod(msg) or matches[1] == "لیست سکوت" and is_mod(msg) then
  return silent_users_list(chat)
 end
if matches[1] == "banlist" and is_mod(msg) or matches[1] == "لیست مسدودها" and is_mod(msg) then
